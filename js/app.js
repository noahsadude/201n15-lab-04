...
// var normalizeUserName = userName.toLowerCase();
// var checkUserName;
// checkUserName = findStuffInThings(cohort, normalizeUserName);
// if(checkUserName === -1) {
//   alert ('We didn\'t find you on the list ' + userName);
// } else {
//   alert ('Welcome, ' + userName);
// }


function trueOrFalse (question, rightAnswer, wrongAnswer, responseIfTrue, responseIfFalse){
  var checkIfComplete = '';
  // var questionInput = prompt(question);
...
trueOrFalse ('Chuck Norris?', 'always' , 'never', 'you\'re the best around.', 'roundhouse kick to the face!'); 
